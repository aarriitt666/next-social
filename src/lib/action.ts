...
export const switchBlock = async (userId: string) => {
  ...
  try {
    ...
    if (existingBlock) {
      ...
      // Also remove any existing follow relationships when blocking a user
      ...
      // Also remove any existing follow requests when blocking a user
...
export const acceptFollowRequest = async (userId: string) => {
  ...
  try {
    ...
    if (existingFollowRequest) {
      ...
      // Create follower records for both users to ensure mutual following
