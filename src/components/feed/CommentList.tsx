      ...
      {user && (
        <div className="flex items-center gap-4">
          ...
          <form action={add} className="flex-1 flex items-center justify-between bg-slate-100 rounded-xl text-sm px-6 py-2 w-full">
            <input type="text" placeholder="Write a comment..." className="w-full bg-transparent outline-none flex-1" onChange={(e) => setDesc(e.target.value)} />
            ...
            <div className="flex flex-col gap-2 flex-1">
              ...
              <div className="flex items-center gap-8 text-xs text-gray-500 mt-2">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-500">0 Like</span>
                </div>
